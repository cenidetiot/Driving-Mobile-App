 ...
 */
public class HttpPostCreateAsync extends AsyncTask<String, String, Response> {
    ...
    ExecRequestPost execRequest;
    Response response;

    public HttpPostCreateAsync(ExecRequestPost execRequest) {
        this.execRequest = execRequest;
    }

    public interface ExecRequestPost {
